...
class Service5_admin_view extends CI_Controller
{
    ...
    public function display_data()
    {
        ...
        // $this->load->view('admin/Service_5_section/view', $data);
        $this->load->view('admin/Service_5_section/view', $data);
    }
    ...
    public function add()
    {
        if ($this->input->post()) {
            ...
            if ($this->upload->do_upload('main_img')) {
                ...
                $result = $this->Service_5_model->add($data);
            ...
            redirect('admin/Service5_admin_view/display_data');
        } else {
            $this->load->view('admin/Service_5_section/add');
        }
    }
        ...
        if ($this->input->post()) {
            ...
            if (!empty($_FILES['main-img']['name'])) {
                ...
                if ($this->upload->do_upload('main-img')) {
                    ...
                    $this->session->set_flashdata('error', $this->upload->display_errors());
                    redirect('admin/Service5_admin_view/edit/' . $id);
                }
            }
            ...
            $result = $this->Service_5_model->edit($id, $data);
            ...
            $data['service'] = $this->Service_5_model->get_service_by_id($id);
            $this->load->view('admin/Service_5_section/edit', $data);
        }
    }
    ...
    public function delete($id = null)
    {
        ...
        $result = $this->Service_5_model->delete($id);
