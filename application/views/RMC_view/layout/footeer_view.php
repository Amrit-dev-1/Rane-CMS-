        ...
        <div class="container-fluid p-4">
            <div class="row">
                <div class="col-lg-4 col-md-6 col-sm-12 mb-4 mb-md-0">
                    ...
                    <!--    <a class="social-btn"><img src="<?php base_url(); ?>assets/image/icon/facebook.png" alt="facebook"></a>-->
                    <!--    <a class="social-btn"><img src="<?php base_url(); ?>assets/image/icon/twitter.png" alt="twitter"></a>-->
                    <!--    <a class="social-btn"><img src="<?php base_url(); ?>assets/image/icon/linkedin-in.png" alt="linkedin-in"></a>-->
                    <!--    <a class="social-btn"><img src="<?php base_url(); ?>assets/image/icon/instagram.png" alt="instagram"></a>-->
                    <!--    <a class="social-btn"><img src="<?php base_url(); ?>assets/image/icon/youtube.png" alt="youtube"></a>-->
                    <!--</div>-->
                ...
                <div class="col-lg-4 col-md-6 col-sm-12 mb-4 mb-md-0">
                    ...
                    <ul class="list-group footer-list ">
                        <li class="list-group-item">
                            <p> <i class="fa fa-chevron-right"></i> <a href="<?php base_url(); ?>About_us" class="footer-link">About Us</a> </p>
                        </li>

                        <li class="list-group-item">
                            <p> <i class="fa fa-chevron-right"></i> <a href="<?php base_url(); ?>Land_advisory_services " class="footer-link"> Land-Advisory </a></p>
                        </li>

                        <li class="list-group-item">
                            <p> <i class="fa fa-chevron-right"></i> <a href="<?php base_url(); ?>Careers_at_Rane_management_consultant " class="footer-link"> Careers </a></p>
                        </li>
                        <li class="list-group-item">
                            <p> <i class="fa fa-chevron-right"></i> <a href="<?php base_url(); ?> Blog" class="footer-link"> Blog </a> </p>
                        </li>
                        <li class="list-group-item">
                            <p> <i class="fa fa-chevron-right"></i> <a href="<?php base_url(); ?>Contact_us" class="footer-link"> Contact-us </a> </p>
                        </li>
                    </ul>
                </div>
