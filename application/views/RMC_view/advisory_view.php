...
<div class="row button-la">
    <div class="col-md-3"><button><img src="<?php echo base_url(); ?>assets/image/icon/FraudPrevention-01.svg" alt=" FraudPrevention">
            <p>Fraud Prevention</p>
        </button></div>
    <div class="col-md-3"><button><img src="<?php echo base_url(); ?>assets/image/icon/LocationVerification-01.svg" alt=" LocationVerification">
            <p>Location Verification</p>
        </button></div>
    <div class="col-md-3"><button><img src="<?php echo base_url(); ?>assets/image/icon/QuicknInformedDecisions-01.svg" alt=" QuicknInformedDecisions">
            <p style="padding: 18px 0px;">Quick & Informed Decisions</p>
        </button></div>

    <div class="col-md-3"><button><img type="image/svg+xml" src="<?php echo base_url(); ?>assets/image/icon/Government-Trust.svg" alt=" GovernmentTrust">
