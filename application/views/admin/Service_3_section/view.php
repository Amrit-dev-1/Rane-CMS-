            ...
            <div class="col-12">
              <div class="card">
                <div class="card-header">
                  <h3 class="card-title">Land Record Verification & Modifcation</h3>
                  <div class="card-tools">
                    <a href="<?php echo base_url() ?>admin/service3_admin_view/add">
                      ...
                      <?php if (!empty($services)) : ?>
                        <?php foreach ($services as $service) : ?>
                          <tr>
                            ...
                            <td>
                              <a href="<?php echo base_url() ?>admin/service3_admin_view/edit/<?php echo $service->id; ?>" class="btn btn-info">Edit</a>
                       
                              <a href="<?php echo base_url() ?>admin/service3_admin_view/delete/<?php echo $service->id; ?>" class="btn btn-danger" onclick="return confirm('Are you sure you want to delete this data?');">Delete</a>
                            </td>
                          </tr>
                        <?php endforeach; ?>
                      <?php else : ?>
