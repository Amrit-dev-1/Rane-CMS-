              ...
              <div class="card">
                <div class="card-header">
                  ...
                  <div class="card-tools">
                    <a href="<?php echo base_url() ?>admin/service1_admin_view/add">
                      ...
                      <?php if (!empty($services)) : ?>
                        <?php foreach ($services as $service) : ?>
                          <tr>
                            ...
                            <td>
                              <a href="<?php echo base_url() ?>admin/service1_admin_view/edit/<?php echo $service->id; ?>" class="btn btn-info">Edit</a>
                              <a href="<?php echo base_url() ?>admin/service1_admin_view/delete/<?php echo $service->id; ?>" class="btn btn-danger" onclick="return confirm('Are you sure you want to delete this data?');">Delete</a>
                            </td>
                          </tr>
                        <?php endforeach; ?>
                      <?php else : ?>
